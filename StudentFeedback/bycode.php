         ...
         <div id="n1" style="width: 1350px;height: 500px;">
            <header>
               <img src="cit eight.png" width=100px" style="float: left">
                ...
                <div style="height: 40px;background-color: cadetblue"><h1 style="font-size: 30px;color: white;float: inside"><center>ONLiNE FEEDBACK STSTEM</center></h1></div>
                 </header>
...
echo "<table border='1'>".
       ...
       $i="SELECT * from feedbacks where Sub_code='$aaa'";
